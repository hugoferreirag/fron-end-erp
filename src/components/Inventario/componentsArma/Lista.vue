...
import { mapActions } from "vuex";
  export default {
    ...
    data() {
      return {
        ...
        fields: [
          ...
          { key: 'caliber', label: 'Calibre', sortable: true,class: 'text-left', sortDirection: 'desc' },
          { key: 'bar_code', label: 'C/Barras', sortable: true,class: 'text-left', sortDirection: 'desc' },
          { key: 'provider', label: 'Imbel', sortable: true,class: 'text-left', sortDirection: 'desc' },
          { key: 'numeration', label: 'Numeração', sortable: true,class: 'text-left', sortDirection: 'desc' },
          { key: 'nf', label: 'N/Fiscal', sortable: true,class: 'text-left', sortDirection: 'desc' },
    ...
    computed: {
      ...
      arma(){
          return this.$store.state.Inventario.arma
      },
      user(){
    ...
    mounted() {
      ...
      this.totalRows = this.arma.length
    },
    methods: {
