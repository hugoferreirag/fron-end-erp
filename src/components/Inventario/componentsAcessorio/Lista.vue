...
import { mapActions } from "vuex";
  export default {
    ...
    data() {
      return {
        ...
        fields: [
          ...
          { key: 'model', label: 'Nome', sortable: true,class: 'text-left', sortDirection: 'desc' },
          { key: 'bar_code', label: 'C/Barras', sortable: true,class: 'text-left', sortDirection: 'desc' },
          { key: 'provider', label: 'Fornecedor', sortable: true,class: 'text-left', sortDirection: 'desc' },
    ...
    computed: {
      ...
      arma(){
          return this.$store.state.Inventario.acessorio
      },
      user(){
    ...
    methods: {
      ...
      remove(id){
        this.$http.delete(`/acessorios/${id}`)
        .then(res=>{
