...
import { mapActions } from "vuex";
  export default {
    ...
    data() {
      return {
        ...
        fields: [
          ...
          { key: 'model_box', label: 'Modelo/Caixa', sortable: true,class: 'text-left', sortDirection: 'desc' },
          ...
          { key: 'unity_value', label: 'Valor Und', sortable: true,class: 'text-left', sortDirection: 'desc' },
    ...
    computed: {
      ...
      municao(){
          return this.$store.state.Inventario.municaoInventory
      },
      user(){
    ...
    methods: {
      ...
      remove(id){
        this.$http.delete(`/municoes/model/${id}`)
        .then(res=>{
          if(res.status == 200){
