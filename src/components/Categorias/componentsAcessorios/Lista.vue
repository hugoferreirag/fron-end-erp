...
import { mapActions } from "vuex";
  export default {
    ...
    data() {
      return {
        ...
        fields: [
          ...
          { key: 'type', label: 'Nome', sortable: true,class: 'text-left', sortDirection: 'desc' },
          { key: 'model', label: 'Nome', sortable: true,class: 'text-left', sortDirection: 'desc' },
          { key: 'provider_name', label: 'Nome', sortable: true,class: 'text-left', sortDirection: 'desc' },
    ...
    methods: {
      ...
      remove(id){
        this.$http.delete(`/acessorios/categoria/${id}`)
        .then(res=>{
          console.log(res)
          if(res.status == 200){
